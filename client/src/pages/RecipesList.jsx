...
import { getRecipes, createRecipe, getLocations, getRecipesCategories } from '../api';
...
function NewRecipeModal({ locations, categories, onCreate, onClose }) {
  ...
  const handleSave = async (e) => {
    ...
    setError('');
    try {
      const r = await createRecipe({ name: name.trim(), category: category || null, status, location_ids: locs });
